...
class CustomUserAdmin(UserAdmin):
    ...
    list_display = ['username', 'email', 'first_name', 'last_name', 'gender', 'phone_number', 'profile_picture']


# Unregister Profile if already registered
try:
    admin.site.unregister(Profile)
except admin.sites.NotRegistered:
    pass  # Profile wasn't registered, no need to do anything
