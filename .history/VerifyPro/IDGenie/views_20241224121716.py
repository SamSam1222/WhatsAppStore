...
def signup_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('IDGenie:index')  # Redirect to the desired page (like home or dashboard)
        else:
            ...
            # Debug: print the cleaned gender data
            print(form.cleaned_data.get('gender'))  # Check the gender value
